//
//  BBTClubLoginViewController.m
//  波板糖
//
//  Created by Authority on 2017/9/24.
...
@interface BBTClubLoginViewController ()
...
@implementation BBTClubLoginViewController

extern NSString * kUserClubLoginFinishNotifName;

- (void)viewWillAppear:(BOOL)animated
{
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(didReceiveUserAuthenticationNotif)
                                                 name:kUserClubLoginFinishNotifName
                                               object:nil];
}
...
- (void)didReceiveUserAuthenticationNotif
{
    if ([BBTCurrentUserManager sharedCurrentUserManager].clubUserIsActive)
    {
        ...
        [JNKeychain saveValue:[NSNumber numberWithBool:true] forKey:@"appSwitchStatus"];
